...
```sh
  cd my-folder
  git clone https://github.com/rachaouldbabaali/budget-app.git
```
...
Feel free to check the [issues page](https://github.com/rachaouldbabaali/budget-app/issues).
...
If you like this project please leave a STAR to the [Github repo](https://github.com/rachaouldbabaali/budget_app/)
